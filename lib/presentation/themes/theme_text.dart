...
class AppTextTheme {
  ...
  static const style10px = TextStyle(
    fontSize: 10.0,
    fontWeight: FontWeight.w400,
  ...
  static const normalNunito = TextStyle(
    color: Colors.black,
    fontSize: 14,
    fontWeight: FontWeight.w400,
    fontFamily: 'Nunito',
  ...
  static const normalNunitoBlack = TextStyle(
    color: Colors.black,
    fontSize: 14,
    fontWeight: FontWeight.w400,
    fontFamily: 'Nunito',
  ...
  static const normalNunitoRed = TextStyle(
    color: Colors.red,
    fontSize: 14,
    fontWeight: FontWeight.w400,
    fontFamily: 'Nunito',
  ...
  static const normalNunitoWhite = TextStyle(
    color: Colors.white,
    fontSize: 14,
    fontWeight: FontWeight.w400,
    fontFamily: 'Nunito',
